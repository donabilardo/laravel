...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <p class="inf">
                Внутри функции-колбэка напишите код, который создаст новый экземпляр модели Employee, и сохраните его в
                базу данных с помощью метода save().
            </p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-6">
            <form class="del_user" method="post" action="del_user">
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-danger del_user_link" href="">Удалить пользователя</button>
                </div>
            </form>
        </div>
        <div class="col-6">
